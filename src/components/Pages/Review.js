...
const Review = ({ review }) => {
    ...
    return (
        <div className="card card-compact bg-white border rounded-lg hover:border-secondary transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-105 duration-300">
